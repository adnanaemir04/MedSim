    ...
    public static async Task SeedAsync(MedSimDbContext context)
    {
        ...
        AddKQ(
            ...
            ("Brakiyal pleksusun kökleri aşağıdaki spinal sinirlerden hangisinden kaynaklanır?",
             "C4-C8", "C5-T1", "C6-T1", "C5-C8", "C4-T1", "B",
            ...
            ("Brakiyal pleksusun hangi komponenti C5 ve C6 köklerinin birleşmesiyle oluşur?",
             "Lateral kord", "Medial trunk", "Superior trunk", "Middle trunk", "Posterior kord", "C",
        ...
        AddKQ(
            ...
            ("N. musculocutaneus hasarından sonra hangi hareket en çok etkilenir?",
             "Ön kol pronasyonu", "El bileği fleksiyonu", "Ön kol supinasyonu ve fleksiyonu", "Parmak ekstansiyonu", "Omuz abduksiyonu", "C",
        ...
        AddKQ(
            ...
            ("Nervus medianus hasarında aşağıdaki kasların hangisinin parezisi beklenmez?",
             "Abductor pollicis brevis", "Opponens pollicis", "Adductor pollicis", "Flexor pollicis brevis (yüzeyel baş)", "1. ve 2. lumbrical", "C",
            ...
            ("Karpal tünel sendromunda duyu kaybı en sık hangi parmakları etkiler?",
             "4. ve 5. parmaklar", "Yalnızca 1. parmak", "1., 2., 3. parmak ve 4. parmağın radyal yarısı", "4. ve 5. parmağın ulnar yarısı", "Tüm parmaklar eşit etkilenir", "C",
        ...
        AddKQ(
            ...
            ("N. ulnaris hasarında aşağıdaki deformitelerden hangisi gelişir?",
             "Düşük el (wrist drop)", "Düşük ayak (foot drop)", "Pençe el (claw hand)", "Benediction işareti", "Ape hand deformitesi", "C",
            ...
            ("El bileği seviyesinde n. ulnaris hasarında hangi hareket etkilenmez?",
             "Parmak abduksiyonu", "5. parmak abduksiyonu", "4-5. parmak fleksiyonu (MCP)", "Adductor pollicis fonksiyonu", "El bilek fleksiyonu", "E",
        ...
        AddKQ(
            ...
            ("N. radialis hasarına bağlı 'wrist drop' tablosunda en çok hangi hareket bozulur?",
             "El bileği fleksiyonu", "Ön kol supinasyonu", "El bileği ekstansiyonu", "Parmak adduksiyonu", "Başparmak abduksiyonu", "C",
        ...
        AddKQ(
            ...
            ("Doğum travmasında brakiyal pleksusun üst kök hasarıyla oluşan tablonun adı nedir?",
             "Klumpke paralizisi", "Carpal tünel sendromu", "Erb (Duchenne-Erb) paralizisi", "Dejerine-Klumpke sendromu", "Horner sendromu", "C",
            ...
            ("Klumpke paralizisinde hangi kökler zarar görmüştür?",
             "C5-C6", "C5-C7", "C6-C7", "C8-T1", "C7-T1", "D",
        ...
        AddKQ(
            ...
            ("Supraspinatus ve infraspinatus kaslarının innervasyonundan hangi sinir sorumludur?",
             "N. axillaris", "N. thoracodorsalis", "N. suprascapularis", "N. subscapularis", "N. musculocutaneus", "C",
        ...
        AddKQ(
            ...
            ("Aksiller arterin 3 bölümü içinde en fazla dalı veren bölüm hangisidir?",
             "Birinci bölüm (1 dal)", "İkinci bölüm (2 dal)", "Üçüncü bölüm (3 dal)", "Tüm bölümler eşit sayıda dal verir", "Hiçbiri doğru değil", "C",
        ...
        AddKQ(
            ...
            ("El bileği karpal kemikleri arasında kırık sonrası avasküler nekroz riski en yüksek olan kemik hangisidir?",
             "Lunate", "Triquetrum", "Scaphoid (navikular)", "Capitate", "Hamate", "C",
        ...
        AddKQ(
            ...
            ("Humerus medial epikondiline ilişkin olarak aşağıdakilerden hangisi doğrudur?",
             "N. radialis bu oluk üzerinden geçer", "Golfçü dirseği medial epikondil ağrısıyla ilişkilidir", "Tenis dirseği medial epikondil ağrısına yol açar", "N. musculocutaneus bu bölgede yüzeyselleşir", "Lateral epikondilden daha az hassastır", "B",
        ...
        AddKQ(
            ...
            ("Vücutta en sık disloke olan eklem hangisidir?",
             "Kalça eklemi", "Dirsek eklemi", "Diz eklemi", "Glenohumeral (omuz) eklemi", "El bilek eklemi", "D",
        ...
        AddKQ(
            ...
            ("Dirsek pronasyon-supinasyon hareketinden sorumlu eklem hangisidir?",
             "Humeroulnar eklem", "Humeroradial eklem", "Proksimal radioulnar eklem", "Distal radioulnar eklem", "Proksimal radioulnar eklem ve distal radioulnar eklem birlikte", "E",
        ...
        AddKQ(
            ...
            ("Supraspinatus kası aşağıdaki hareketlerden hangisinden birincil sorumludur?",
             "Omuz iç rotasyonu", "Omuz dış rotasyonu", "Omuz abduksiyonunun ilk 0-15 derecesi", "Skapula depresyonu", "Omuz fleksiyonu", "C",
            ...
            ("Rotator cuff kasları içinde iç rotasyondan sorumlu olan tek kas hangisidir?",
             "Supraspinatus", "Infraspinatus", "Teres minor", "Subscapularis", "Deltoid (ön lif)", "D",
        ...
        AddKQ(
            ...
            ("Biceps brachii kasının birincil fonksiyonu aşağıdakilerden hangisidir?",
             "Ön kol pronasyonu", "Omuz abduksiyonu", "Ön kol supinasyonu ve dirsek fleksiyonu", "Dirsek ekstansiyonu", "Parmak fleksiyonu", "C",
            ...
            ("Biceps brachii'nin uzun başı hangi yapıdan köken alır?",
             "Coracoid process", "Glenoid labrum üst kenarı (supraglenoid tüberkül)", "Humerus anatomik boynu", "Akromion", "Klavikula lateral ucu", "B",
        ...
        AddKQ(
            ...
            ("Dirsek ekstansiyonundan sorumlu temel kas hangisidir?",
             "Biceps brachii", "Brachialis", "Brachioradialis", "Triceps brachii", "Ankoneus", "D",
        ...
        AddKQ(
            ...
            ("N. femoralis hasarında en belirgin hareket kaybı hangi harekettte beklenir?",
             "Kalça iç rotasyonu", "Kalça adduksiyonu", "Diz ekstansiyonu (quadriceps parezi)", "Ayak plantar fleksiyonu", "Kalça abduksiyonu", "C",
            ...
            ("N. femoralis hasarında duyusal kayıp en çok nereden beklenir?",
             "Ayak tabanı", "Ayak dış kenarı", "Uyluk ön ve iç yüzü, bacak iç yüzü", "Uyluk arka yüzü", "Diz arka yüzü", "C",
        ...
        AddKQ(
            ...
            ("N. ischiadicus, popliteal fossada genellikle hangi sinir dallarına ayrılır?",
             "N. tibialis ve n. femoralis", "N. suralis ve n. saphenus", "N. tibialis ve n. fibularis communis", "N. gluteus superior ve inferior", "N. obturatorius ve n. femoralis", "C",
        ...
        AddKQ(
            ...
            ("Alt ekstremitede en sık kompresyon yaralanmasına uğrayan sinir hangisidir?",
             "N. tibialis", "N. femoralis", "N. fibularis communis", "N. ischiadicus", "N. obturatorius", "C",
            ...
            ("N. fibularis communis hasarında hangi hareket kaybı ve duyu defisiti beklenir?",
             "Plantar fleksiyon kaybı ve topuk arka yüzünde duyu kaybı", "Diz ekstansiyon kaybı ve uyluk ön yüzünde duyu kaybı", "Ayak dorsifleksiyon ve eversiyon kaybı (düşük ayak) + ayak ve bacak ön yüzünde duyu kaybı", "Kalça abdüksiyon kaybı ve gluteal duyu kaybı", "Parmak fleksiyon kaybı ve ayak tabanında duyu kaybı", "C",
        ...
        AddKQ(
            ...
            ("Femur boyun kırığının avasküler nekroz riskinin en yüksek olduğu tip hangisidir?",
             "Subtrokanterik kırık", "Trokanterik kırık", "Subkapital kırık (intrakapsüler)", "İntrokanterik kırık", "Şaft kırığı", "C",
        ...
        AddKQ(
            ...
            ("Bacak kemiği kırıklarında geç iyileşme ve yara komplikasyonu riski neden tibiada daha yüksektir?",
             "Tibia daha az kanlandığından", "Tibianın medial yüzü subkutanöz olduğundan yumuşak doku koruması yetersizdir", "Tibia kaslardan daha az destek alır", "Tibia periost içermez", "Tüm bunlar doğrudur", "B",
        ...
        AddKQ(
            ...
            ("Patella hangi tendonun içinde bulunur ve vücudun hangi sesamoid kemiğidir?",
             "Hamstring tendonu içinde, en büyük sesamoid kemik", "Quadriceps tendonu içinde, en büyük sesamoid kemik", "Patellar ligament içinde, en küçük sesamoid kemik", "İliotibial bant içinde, en büyük sesamoid kemik", "Gastrocnemius tendonu içinde", "B",
        ...
        AddKQ(
            ...
            ("Ayak bileği inversiyonunda en sık yırtılan ligaman hangisidir?",
             "Deltoid ligaman (medial)", "Tibiofibular ligaman", "Anterior talofibular ligaman (ATFL)", "Kalsaneofibular ligaman", "Posterior talofibular ligaman", "C",
        ...
        AddKQ(
            ...
            ("Kafa kemiklerinin çoğu hangi ossifikasyon tipiyle oluşur?",
             "Endokondral ossifikasyon", "İntramembranöz ossifikasyon", "Periosteal ossifikasyon", "Subkondral ossifikasyon", "Fibröz ossifikasyon", "B",
        ...
        AddKQ(
            ...
            ("Kemik rezorpsiyonu (erimesi) hangi hücre tipi tarafından gerçekleştirilir?",
             "Osteositler", "Osteoblastlar", "Osteoklastlar", "Kondroitler", "Fibroblastlar", "C",
        ...
        AddKQ(
            ...
            ("Yetişkinlerde kırmızı kemik iliği hangi kemiklerde ağırlıklı olarak bulunur?",
             "Uzun kemiklerin diyafizlerinde", "Yassı kemikler ve kısa kemiklerde (vertebra, sternum, iliak kanat)", "Tüm kemik iliğinde eşit dağılır", "Yalnızca femur boynunda", "Yalnızca humerus proksimalinde", "B",
        ...
        AddKQ(
            ...
            ("En hareketli eklem tipi hangisidir ve kaç harekete izin verir?",
             "Synarthrosis (fibröz eklem) — 0 hareket", "Amphiarthrosis (kıkırdaklı eklem) — sınırlı hareket", "Diarthrosis (sinovyal eklem) — serbest hareket", "Hemi-arthrosis — tek düzlemde hareket", "Syndesmosis — yay hareketi", "C",
            ...
            ("Sinovyal sıvı (sinovya) hangi yapı tarafından üretilir?",
             "Periost", "Subkondral kemik", "Sinovyal membran", "Fibröz kapsül", "Eklem diski", "C",
        ...
        AddKQ(
            ...
            ("Diz ekleminde medial menisküs lateral menisküse kıyasla daha sık yaralanır; bunun temel nedeni nedir?",
             "Medial menisküs daha büyüktür", "Medial menisküs medial kollateral ligamana yapışık olduğundan hareketi kısıtlıdır", "Lateral menisküs daha yoğun kıkırdaktan yapılmıştır", "Medial menisküs daha zayıf beslenir", "Medial menisküs daha az kıkırdak içerir", "B",
        ...
        AddKQ(
            ...
            ("Yetişkinlerde medulla spinalis hangi seviyede sonlanır?",
             "T12 vertebra alt kenarı", "L1-L2 disk seviyesi (conus medullaris)", "L3-L4 disk seviyesi", "S1 vertebra seviyesi", "C5 vertebra seviyesi", "B",
        ...
        AddKQ(
            ...
            ("Lateral kortikospinal yolun çaprazlaşma (dekussasyon) yaptığı yer neresidir?",
             "Mezensefalon (beyin sapı üstü)", "Pons alt bölümü", "Medulla oblongata piramid çaprazlaşması", "Spinal kord servikal bölümü", "Talamus", "C",
            ...
            ("Beynin sağ motor korteksinin bir lezyonunda hangi taraf motor etkilenir?",
             "Sağ taraf (ipsilateral)", "Sol taraf (kontralateral)", "Her iki taraf eşit etkilenir", "Yalnızca kraniyel sinir kasları etkilenir", "Bası durumunda hiç etkilenmez", "B",
        ...
        AddKQ(
            ...
            ("Medulla spinalisin dorsal kolonları hangi duyuları taşır?",
             "Ağrı ve ısı duyusu (kontralateral)", "İnce dokunma, vibrasyon ve bilinçli propriosepsiyon (ipsilateral)", "Ağrı, ısı ve kaba dokunma (ipsilateral)", "Sadece propriosepsiyon (kontralateral)", "Motor komutlar (kontralateral)", "B",
        ...
        AddKQ(
            ...
            ("Lateral spinotalamik yol spinal korda girdikten sonra çaprazlaşma nerede gerçekleştirir?",
             "Medulla oblongata'da", "Ponsta", "Aynı seviyede veya 1-2 segment üstte anterior komissürde", "Mezensefalon'da", "Hiç çapraz yapmaz, ipsilateral seyreder", "C",
            ...
            ("Brown-Séquard sendromu nedir ve hangi bulgular beklenir?",
             "Spinal kordun tamamının kesilmesi — komple tetrapleji", "Spinal kordun yarısının kesilmesi — ipsilateral motor ve dorsal kolon kaybı, kontralateral spinotalamik kayıp", "Anterior spinal arterin tıkanması — bilateral motor ve spinotalamik kayıp, dorsal kolon korunur", "Sadece arka kordonların etkilenmesi — propriosepsiyon kaybı", "Santral kord sendromu — üst ekstremite > alt ekstremite parezi", "B",
        ...
        AddKQ(
            ...
            ("Anterior spinal arter sendromunda hangi duyular korunur?",
             "Ağrı ve ısı duyusu", "Motor fonksiyon", "Vibrasyon ve propriosepsiyon (dorsal kolon)", "Tüm duyular kaybolur", "Yalnızca motor korunur", "C",
        ...
        AddKQ(
            ...
            ("Beyinin dorsal (arka) yüzünden çıkan tek kraniyal sinir hangisidir?",
             "CN III (N. oculomotorius)", "CN IV (N. trochlearis)", "CN VI (N. abducens)", "CN VII (N. facialis)", "CN XII (N. hypoglossus)", "B",
            ...
            ("Pons'tan çıkan kraniyal sinirlerin doğru listesi aşağıdakilerden hangisidir?",
             "CN III, IV", "CN IX, X, XI", "CN V, VI, VII, VIII", "CN I, II", "CN XI, XII", "C",
        ...
        AddKQ(
            ...
            ("Serotonin üreten nöronlar ağırlıklı olarak hangi yapıda bulunur?",
             "Locus coeruleus", "Substansia nigra", "Raphe nukleusları", "Hippokampus", "Amigdala", "C",
        ...
        AddKQ(
            ...
            ("Sağ serebellar hemisfer lezyonunda koordinasyon bozukluğu hangi tarafta beklenir?",
             "Sol tarafta (kontralateral)", "Sağ tarafta (ipsilateral)", "Her iki tarafta eşit", "Yalnızca gövdede", "Bacaklarda değil kolda", "B",
            ...
            ("Serebellar vermis hasarında öne çıkan belirti hangisidir?",
             "Sağ el ataksisi", "Sağ alt ekstremite tremoru", "Gövde ataksisi ve yürüme bozukluğu (truncal ataxia)", "Nistagmus olmaksızın denge kaybı", "Bilateral ekstremite tremoru", "C",
        ...
        AddKQ(
            ...
            ("Hangi duyu, talamus üzerinden geçmeden direkt kortekse ulaşır?",
             "Görme", "İşitme", "Ağrı ve ısı", "Koku (olfaksiyon)", "Dokunma", "D",
            ...
            ("Hipotalamus vücudun hangi temel işlevlerini düzenler?",
             "Yalnızca vücut ısısını", "Yalnızca uyku-uyanıklık döngüsünü", "Otonom, endokrin ve homeostatik işlevleri (su dengesi, ısı, açlık, uyku, üreme)", "Yalnızca üreme hormonlarını", "Yalnızca stres yanıtını", "C",
        ...
        AddKQ(
            ...
            ("ADH hangi yapıda üretilir ve hangi yapıdan kana salınır?",
             "Adenohipofizde üretilir, nörohipofizden salınır", "Hipotalamusta üretilir, nörohipofizden (arka hipofiz) salınır", "Nörohipofizde üretilir ve depolanır", "Epifizde üretilir, talamus üzerinden salınır", "Hipotalamusta üretilir, adenohipofizden salınır", "B",
        ...
        AddKQ(
            ...
            ("Broca afazisinde (ekspresif afazi) hangi bozukluk ön plandadır?",
             "Konuşmayı anlama bozukluğu, akıcı konuşma", "Konuşma üretiminde bozukluk, anlama görece korunmuş", "Hem üretim hem anlama bozulmuş (global afazi)", "Yalnızca okuma bozukluğu", "Yalnızca yazma bozukluğu", "B",
        ...
        AddKQ(
            ...
            ("Mediyal yüzeyi etkileyen serebral korteks lezyonunda hangi vücut bölgesinin güçsüzlüğü daha belirgin olur?",
             "Yüz ve el parmaklarında", "Alt ekstremitede (özellikle ayakta)", "Gövde kaslarında", "Üst ekstremite proksimalinde", "Ağız çevresinde", "B",
        ...
        AddKQ(
            ...
            ("CN III hasarında göz bulguları aşağıdakilerden hangisidir?",
             "Göz aşağı-içe bakar (adduksiyona döner)", "Göz aşağı-dışa bakar (down and out), ptoz, midriyazis", "Göz yalnızca iç yöne bakar, miosis", "Göz sabitlenir, eşit pupil", "Yalnızca ptoz, göz hareketleri normaldir", "B",
            ...
            ("'Surgical CN III palsy'de neden midriyazis öne çıkar?",
             "Motor liflerin dışarıda seyretmesi", "Parasempatik liflerin CN III'ün dışarı kısmında seyretmesi (kompresyon ile erken etkilenir)", "Sempatik lifler hasarlı olduğundan", "İris sfinkteri CN VI tarafından innerve edildiğinden", "Pupilla refleksi CN IV'e bağlı olduğundan", "B",
        ...
        AddKQ(
            ...
            ("CN IV hasarında ortaya çıkan çift görme (diplopi) hangi yöne bakışta artar?",
             "Yukarı ve dışa bakışta", "Aşağı ve içe bakışta (ör. merdiven inme)", "Yana bakışta", "Yalnızca uzağa bakışta", "Işığa bakışta", "B",
        ...
        AddKQ(
            ...
            ("Çiğneme kaslarını (masseter, temporalis, pterygoidler) hangi sinir innerve eder?",
             "CN VII (fasiyal sinir)", "CN IX (glossofarengeal sinir)", "CN V3 (n. mandibularis, trigeminal sinirin üçüncü dalı)", "CN XII (hipoglossal sinir)", "CN XI (aksesuar sinir)", "C",
            ...
            ("Kornea refleksinin afferent kolu hangi sinirle taşınır?",
             "CN VII", "CN II", "CN V1 (oftalmik dal)", "CN III", "CN IX", "C",
        ...
        AddKQ(
            ...
            ("CN VI hasarında göz hareketi nasıl etkilenir?",
             "Gözde yukarı bakış kaybı", "Gözde içe bakış (adduksiyon) kaybı", "Gözde dışa bakış (abduksiyon) kaybı — göz içe kayar (ezoterapi)", "Gözde aşağı bakış kaybı", "Gözde tüm hareketler kaybolur", "C",
        ...
        AddKQ(
            ...
            ("Periferik CN VII (fasiyal sinir) hasarında üst ve alt yüz kaslarının etkilenme durumu nasıldır?",
             "Yalnızca alt yüz kasları (merkezi tip gibi) etkilenir", "Yalnızca üst yüz kasları etkilenir", "Hem üst hem alt yüz kasları ipsilateral etkilenir (tüm yüz)", "Kontralateral yüz etkilenir", "Yalnızca orbicularis oris etkilenir", "C",
        ...
        AddKQ(
            ...
            ("N. vagus'un parasempatik innervasyonu hangi bölgeye kadar uzanır?",
             "Mide çıkışına (pilora) kadar", "Duodenojejunal bileşime (Treitz bağı) kadar", "Sigmoid kolona kadar", "Tüm kolonun sonuna kadar", "Yalnızca toraks organlarına", "B",
            ...
            ("Tekrarlayan laringeal sinir (n. laryngeus recurrens) hangi kraniyal sinirin dalıdır ve sol tarafta hangi yapıyı dolar?",
             "CN IX — karotis arterin arkasını", "CN X (vagus) — sol tarafta aorta arkı altından döner", "CN XI — klavikula altından geçer", "CN XII — hyoid kemiğini dolar", "CN VII — stilomastoid foramenden çıkar", "B",
        ...
        AddKQ(
            ...
            ("Aksesuar sinir (CN XI) hasarında hangi klinik bulgular beklenir?",
             "Dil deviasyonu ve disfaji", "Yüz asimetrisi ve göz kapağı düşüklüğü", "Boyun dönme güçlüğü ve omuz düşüklüğü (trapezius parezi)", "Yutma güçlüğü ve ses kısıklığı", "Denge bozukluğu ve işitme kaybı", "C",
        ...
        AddKQ(
            ...
            ("CN XII (hipoglossal sinir) hasarında dil hangi yöne deviye olur?",
             "Karşı tarafa (kontralateral lezyon yönüne)", "Sağlam tarafa", "Lezyonun olduğu (ipsilateral) tarafa", "Aşağı doğru (deprese olur)", "Yukarı doğru (elevasyona geçer)", "C",
        ...
        AddKQ(
            ...
            ("Hipofiz bezi kafatasında hangi kemik üzerindeki çukurda yer alır?",
             "Etmoid kemik", "Temporal kemik", "Sfenoid kemik (sella turcica)", "Frontal kemik", "Oksipital kemik", "C",
            ...
            ("Foramen magnum hangi kemikte bulunur?",
             "Temporal kemik", "Sfenoid kemik", "Parietal kemik", "Oksipital kemik", "Frontal kemik", "D",
        ...
        AddKQ(
            ...
            ("Temporal kemik kırığında hangi sinir en sık zarar görür?",
             "CN V", "CN VII ve/veya CN VIII", "CN IX", "CN X", "CN III", "B",
        ...
        AddKQ(
            ...
            ("Posterior boyun üçgeninden geçen ve boyun diseksiyonunda zarar görebilen sinir hangisidir?",
             "N. phrenicus", "N. vagus", "N. accessorius (CN XI)", "N. hypoglossus (CN XII)", "N. glossopharyngeus (CN IX)", "C",
        ...
        AddKQ(
            ...
            ("Tiroid kıkırdak hakkında doğru olan ifade aşağıdakilerden hangisidir?",
             "Tek tam halkadır", "İki yaprağı önde birleşerek Adem elması'nı oluşturur", "Elastik kıkırdaktan yapılmıştır", "Yalnızca kadınlarda belirgindir", "Arytenoidlerle direkt eklem yapmaz", "B",
        ...
        AddKQ(
            ...
            ("Vokal kordların addüksiyonunu (yaklaştırılmasını) sağlayan kaslar hangi sinir tarafından innerve edilir?",
             "N. laryngeus superior", "N. glossopharyngeus", "N. laryngeus recurrens (inferior)", "N. phrenicus", "N. vagus'un faringeal dalı", "C",
        ...
        AddKQ(
            ...
            ("Sağ akciğer ile sol akciğerin lob sayısı arasındaki fark ve nedeni aşağıdakilerden hangisinde doğru verilmiştir?",
             "Sağ 2 lob — sol 3 lob; kalbin sağda yer alması", "Sağ 3 lob — sol 2 lob; kalbin sol tarafta yer alması ve kardiyak çentik", "Sağ 2 lob — sol 2 lob; her iki akciğer simetriktir", "Sağ 4 lob — sol 3 lob; plevra uzantısı farklıdır", "Sağ 3 lob — sol 3 lob; sol lingula 3. lob sayılır", "B",
        ...
        AddKQ(
            ...
            ("SA nodunun arteriyel kanlanmasını en sık hangi arterin dalı sağlar?",
             "Sol ön inen arter (LAD)", "Sirkumfleks arter", "Sağ koroner arterin SA nodal dalı", "Posterior inen arter (PDA)", "Marjinal dal", "C",
            ...
            ("AV nodunun arteriyel kanlanmasından en sık hangi damar sorumludur?",
             "Sol ön inen arter (LAD)", "Sirkumfleks arter", "Sağ koroner arterin posterior inen arter (PDA) dalı", "Sol marjinal arter", "Sol posterior inen arter", "C",
        ...
        AddKQ(
            ...
            ("Erken plevral efüzyonda sıvı hangi plevral resesusta birikerek akciğer opasitesi olmadan radyografide görülür?",
             "Costomediastinal recessus", "Mediastinofrenik recessus", "Costodiaphragmatic (kostodiyafragmatik) recessus", "Diaphragmophrenic recessus", "Kardiyofrenik recessus", "C",
        ...
        AddKQ(
            ...
            ("Pankreasın başı hangi yapının içine gömülüdür?",
             "Jejunumun C şekli", "Duodenumun C şekli (C-loop)", "Dalak hilumu", "Karaciğer sol lobu", "Mide fundus", "B",
            ...
            ("Pankreas aşağıdaki özelliklerin hangisi nedeniyle retroperitoneal kabul edilir?",
             "Tüm yüzeyleri peritona sahip olduğundan", "Yalnızca ön yüzü peritona sahip olduğundan (sekonder retroperitoneal)", "Hiç periton kaplı değildir", "Yalnızca posterior yüzü peritonla kaplıdır", "Bir mezosu olduğundan", "B",
        ...
        AddKQ(
            ...
            ("Safra ve pankreas kanallarının birleşerek duodenuma açıldığı yapı (Vater ampulası) duodenumun hangi kısmında yer alır?",
             "Birinci kısım (bulbus duodeni)", "İkinci kısım (inen duodenum)", "Üçüncü kısım (yatay duodenum)", "Dördüncü kısım (çıkan duodenum)", "Duodenojejunal bileşim", "B",
        ...
        AddKQ(
            ...
            ("Portal hipertansiyonda en tehlikeli kanamaya yol açan portosistemik anastomoz hangisidir?",
             "Paraumblikal venlerle (caput medusae)", "Rektum venleri (hemoroidler)", "Alt özofagus varisleri", "Retroperitoneal-renal venöz anastomozlar", "Splenik venöz anastomozlar", "C",
        ...
        AddKQ(
            ...
            ("Kadın pelvisinde üreter ile hangi yapının çaprazlaşma ilişkisi 'water under the bridge' deyimiyle anlatılır?",
             "Ovarian (inguinal) ligament", "Uterus rotundum ligamenti", "A. uterina — uterin arterin üreter üzerinden geçmesi", "Mesane boynu", "Sakrouterin bağ", "C",
            ...
            ("Kadın pelvisinde üreter nerede en riskli anatomik komşuluğa sahiptir?",
             "Böbrek hilumu çıkışında", "Psoas kası üzerinde", "Uterin arterin çaprazlaştığı servikal düzeyde", "Mesane duvarına girişte", "Sakrum önünde", "C",
